...
笔记字段为 StableID、Label、Prompt、Answer、FrontHTML、BackHTML、Source、Target。自定义 data-audio 媒体引用还需登记为隐藏 audio src，使 Anki 识别并导入媒体。音频实际为 1.75×，播放器不重复加速。维护后检查目标卡正反面、媒体、J 键、翻面清理、GUID 和原有复习历史；不要为验证旧选择题而制作新选择题。
