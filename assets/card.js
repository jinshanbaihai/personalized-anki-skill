window.ccptInit=function(){
 ...
 function stop(){if(current){current.pause();current.removeAttribute('src');current.load();current=null;}file='';play.textContent='▶ 听讲 · 1.5×';play.setAttribute('aria-pressed','false');}
